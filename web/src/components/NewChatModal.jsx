...
function NewChatModal({ onStartChat, isPending, isOpen, onClose }) {
  ...
  return (
    <dialog className={`modal ${isOpen ? "modal-open" : ""}`}>
      <div className="modal-box bg-gray-800">
        ...
        <div className="relative mb-4 text-black/80">
              ...
              {searchResults.map((u) => (
                ...
                >
                  <div className="relative">
                    ...
                    {isOnline(u._id) && (
                      <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-success rounded-full border-2 border-gray-900" />
                    )}
                  </div>
